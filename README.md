...
This is a sample template for aws-tempest-alexa-demo - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name aws-tempest-alexa-demo \
...
```bash
sam logs -n HelloWorldFunction --stack-name aws-tempest-alexa-demo --tail
```
...
```bash
aws cloudformation delete-stack --stack-name aws-tempest-alexa-demo
```
