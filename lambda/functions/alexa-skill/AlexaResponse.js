...
//
// adapted from https://github.com/alexa/skill-sample-nodejs-smarthome-switch/blob/master/lambda/smarthome/alexa/skills/smarthome/AlexaResponse.js
...
class AlexaResponse {
    ...
    /**
     * Set endpoints to [], to be used when discovery errors occur:
     * https://developer.amazon.com/docs/device-apis/alexa-discovery.html
     */
    setEndpointsToEmptyArrayDueToDiscoveryError() {
    ...
    createPayloadEndpointCapability(opts) {
        ...
        // Empty params lead to creating default "Alexa" interface:
